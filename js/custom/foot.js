...
span_dt_dt.innerHTML='<font style=color:#fff>'+daysold+'</font> 天 <font style=color:#fff>'+hrsold+'</font> 时 <font style=color:#fff>'+minsold+'</font> 分 <font style=color:#fff>'+seconds+'</font> 秒';
}
